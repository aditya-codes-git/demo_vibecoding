...
/**
 * TouchTexture — Tracks mouse/touch movements and creates a ripple texture.
 */
class TouchTexture {
  constructor() {
    this.size = 64;
...
/**
 * GradientBackground — Animated shader-based gradient with touch interaction.
 */
...
/**
 * ThreeApp — Manages the Three.js renderer, scene, camera, and animation loop.
 */
class ThreeApp {
...
/**
 * LiquidGradient — Interactive animated gradient background component.
 */
export default function LiquidGradient() {
  ...
  return <div ref={containerRef} className="liquid-gradient-bg" />;
}
